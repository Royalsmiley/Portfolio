...
<div class="aboutback">
	<div class="paginainhoud">
		<div class="aboutleft">
			...
			<h1>Document: LPF verslag </h1><br>
             This is a document written in dutch, its about a school project about storyboards, drawing and animation. to see the animation <a href="https://www.youtube.com/watch?v=RfZlWq6I0vY" class="viewLivesite" target="_blank" style="padding-left:30px; font-size:20px;">Click here</a>
			 <br><br>
		...
		<div class="aboutright">
			<ul>
				...
				<li><span>Type:</span> Document</li>
				<li><span>Year:</span> 2016</li>
			</ul>
			<br><br>
			<a href="http://rvandewiel.com/verslag.pdf" class="viewLivesite" target="_blank" style="padding-left:30px; font-size:20px;">View Document</a>
