...
<div class="aboutback">
	<div class="paginainhoud">
		<div class="aboutleft">
			...
			<h1> Brandguide Kris van Son </h1><br>
             A brandguide for Kris van Son, to get a style and guidelines for designs.
			 <br><br>
		...
		<div class="aboutright">
			<ul>
				...
				<li><span>Type:</span> Brandguide</li>
				<li><span>Year:</span> 2015</li>
			</ul>
			<br><br>
			<a href="http://rvandewiel.com/Brandguide.pdf/" class="viewLivesite" target="_blank" style="padding-left:30px; font-size:20px;">View Brandguide</a>
