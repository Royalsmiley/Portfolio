...
<div class="aboutback">
	<div class="paginainhoud">
		<div class="aboutleft">
			...
			<h1>Digital Art </h1><br>
             This is a collection of my digital art, im just experimenting a lot.<br><br>
			 All these drawings belong to me and a copyrighted by me.
			 <br><br>

		</div>
		<div class="aboutright">
			<ul>
				<li><span>Client:</span> Myself</li>
				<li><span>Type:</span> Drawing</li>
				<li><span>Year:</span> 2016</li>
			</ul>
			<br><br>
			<a href="http://rvandewiel.com/digital.pdf" class="viewLivesite" target="_blank" style="padding-left:30px; font-size:20px;">View Drawings</a>
