...
$Content = $_POST['Content'];
	...
	if (isset($_POST['Titel'])){
		 $sql = "UPDATE Contactcontent SET Titel = '$Titel' , Content = '$Content'";
         $db->query($sql);
...
<h1>Contact page</h1> 
<form action="privatecontact.php" method="post"> 
    Titel:<br /> 
    <input type="text" name="Titel" value="<?php echo $row["Titel"] ?>" maxlength="40" required /> 
    <br /><br /> 
    Content:<br /> 
